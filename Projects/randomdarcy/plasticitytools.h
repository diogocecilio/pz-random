...
public:
    ...
    PlasticityTools();
    PlasticityTools(TPZGeoMesh * gmesh,REAL gammaagua, REAL gammasolo,int  numthreads,int porder);
...
PlasticityTools::PlasticityTools(TPZGeoMesh * gmesh,REAL gammaagua,REAL gammasolo,int numthreads,int porder)
{
    fgmesh=gmesh;
