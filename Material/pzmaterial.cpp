...
void TPZMaterial::ContributeB(TPZMaterialData &data, REAL weight, TPZFMatrix<STATE> &ek)
{
  ContributeB(data,weight,ek);
}
	
void TPZMaterial::ContributeC(TPZMaterialData &data1,TPZMaterialData &data2, REAL w1,REAL w2, TPZFMatrix<STATE> &ek)
{
  ContributeC(data1,data2, w1,w2, ek);
}
